  ...
  <motion.div
    ...
    <div className="p-4 font-mono text-xs sm:text-sm md:p-6">
      <div className="mb-4 border-b border-neutral-800 pb-2">
        <span className="font-bold text-cyan-400">GAZE</span> - Next.js
        Development Monitor
      </div>
        ...
        <div className="flex-1 border border-green-500/50 p-2">
          ...
          <div className="space-y-3 text-neutral-300">
            <p>
              ...
              occurs because you are trying to access the browser-only{" "}
              <code className="bg-neutral-800 px-1">window</code> object during
              server-side rendering (SSR).
            </p>
            <p>
              <span className="text-green-400">Fix:</span> Wrap the code in a{" "}
              <code className="bg-neutral-800 px-1">useEffect</code> hook or
              check{" "}
              <code className="bg-neutral-800 px-1">
      ...
      <div className="mt-4 flex items-center justify-between border-t border-neutral-800 pt-2 text-neutral-500">
        <div className="flex items-center gap-2">
          <span className="text-green-500">●</span> PORT:3000 | AI:
        ...
        <div className="hidden text-[10px] md:block">
          ...
          <span className="text-cyan-500">a</span>:ai{" "}
          <span className="text-cyan-500">q</span>:quit
        </div>
      </div>
    </div>
  </motion.div>
    ...
    <main className="min-h-screen bg-[#050505] selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <nav className="fixed left-0 right-0 top-0 z-50 border-b border-neutral-800 bg-black/50 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <a
            href="https://github.com/thetanav/gaze"
            target="_blank"
        ...
        <div className="mx-auto max-w-4xl text-center">
          <motion.div
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-neutral-400 md:text-xl">
              A blazing fast terminal interface for your Next.js development
              server. Real-time error tracking and AI-powered insights, right
              where you work.
            </p>
          ...
          <div className="space-y-8">
            <div className="flex flex-col gap-6 md:flex-row">
              <div className="flex-1 space-y-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-cyan-900/30 font-bold text-cyan-400">
                  1
                </div>
                <h3 className="text-xl font-bold text-white">Run Gaze</h3>
                <p className="text-neutral-400">
                  Execute the command in your terminal. By default, it connects
                  to port 3000.
                </p>
                <div className="mt-2">
                  <CodeBlock command="bunx @10xdevs/gaze" />
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-neutral-400">
                  Running Next.js on a different port? Just pass it as an
                  argument.
                </p>
                <div className="mt-2">
      ...
      <footer className="border-t border-neutral-800 bg-black py-12 text-center">
        ...
        <p className="mt-4 text-sm text-neutral-500">
          Built with ❤️ by{" "}
          <a className="underline" href="https://x.com/tanavtwt">
            @tanavtwt
          </a>
